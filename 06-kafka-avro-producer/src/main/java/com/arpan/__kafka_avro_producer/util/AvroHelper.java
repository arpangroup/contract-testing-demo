package com.arpan.__kafka_avro_producer.util;
...
public class AvroHelper {
    ...
    public static byte[] serializeToAvro(Student student) throws IOException {
        // Assuming you have an Avro schema for Student defined in student_schema.avsc
        Schema schema = new Schema.Parser().parse(new File("D:\\java-projects\\spring-kafka-avro-docker\\kafka-avro-producer\\src\\main\\resources\\avro\\student_schema.avsc"));
